...
data class VisitCompletionEntity(
    ...
    @ColumnInfo(name = "work_sectors") val workSectors: String?,
    @ColumnInfo(name = "work_items") val workItems: String?,
    @ColumnInfo(name = "work_tests") val workTests: String?,
    @ColumnInfo(name = "work_observations") val workObservations: String?,
    @ColumnInfo(name = "technical_result") val technicalResult: String?,
    ...
    @ColumnInfo(name = "technical_report_snapshot") val technicalReportSnapshot: String? = null,
    @ColumnInfo(name = "client_report") val clientReport: String? = null,
    @ColumnInfo(name = "reports_generated_at") val reportsGeneratedAt: Long? = null,
