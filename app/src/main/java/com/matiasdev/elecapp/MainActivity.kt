            ...
            ElecAppTheme {
                Surface(modifier = Modifier.fillMaxSize()) {
                    ElecNavHost(
                        ...
                        referenceDocumentRepository = appContainer.referenceDocumentRepository,
                        referenceDocumentStorage = appContainer.referenceDocumentStorage,
                        demoDataSeeder = appContainer.demoDataSeeder,
                        appDataReset = appContainer.appDataReset,
