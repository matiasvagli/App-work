...
class AppMigrationsV11Test {
    @Test
    fun `migration 10 to 11 assigns general assessment to legacy inspections`() {
        ...
        assertTrue(
            db.sql.any {
                it.contains("ALTER TABLE electrical_inspections ADD COLUMN scope TEXT NOT NULL DEFAULT 'GENERAL_ASSESSMENT'")
            },
        )
    }
}

private class RecordingDatabase : SupportSQLiteDatabase {
